...
const STATUS_COLORS: Record<string, string> = {
  SCHEDULED: "text-brand-600 bg-brand-50 dark:bg-brand-950",
  PENDING: "text-amber-600 bg-amber-50 dark:bg-amber-950",
  PAID: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950",
  LATE: "text-red-600 bg-red-50 dark:bg-red-950",
  NSF: "text-red-700 bg-red-100 dark:bg-red-950",
    ...
    <div>
      ...
      {payments.length > 0 && (
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="rounded-lg border bg-white p-3 dark:bg-zinc-900 dark:border-zinc-800">
                          ...
                          {showRecord === payment.id ? (
                            <div className="flex items-center gap-2 justify-end">
                              <input
                                ...
                                className="w-24 rounded border px-2 py-1 text-xs dark:bg-zinc-800 dark:border-zinc-700"
                              />
                              <select
                                value={recordMethod}
                                onChange={(e) => setRecordMethod(e.target.value)}
                                className="rounded border px-2 py-1 text-xs dark:bg-zinc-800 dark:border-zinc-700"
                              >
                                <option>ACH</option>
                                <option>Wire</option>
                                <option>Check</option>
