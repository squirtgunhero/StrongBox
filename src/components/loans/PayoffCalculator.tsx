    ...
    <div className="rounded-lg border bg-white p-4 dark:bg-zinc-900 dark:border-zinc-800">
      ...
      {payoff && (
        <div className="space-y-2">
          <div className="flex justify-between text-sm py-1.5 border-b dark:border-zinc-800">
          ...
          <div className="flex justify-between text-sm py-1.5 border-b dark:border-zinc-800">
            ...
            <span className="text-xs text-zinc-400">{formatCurrency(payoff.perDiem)}/day</span>
          </div>
          ...
          <div className="flex justify-between text-sm py-2 bg-zinc-50 dark:bg-zinc-800 -mx-4 px-4 rounded-b-lg mt-3">
