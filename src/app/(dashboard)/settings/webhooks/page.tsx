              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 rounded-md border px-3 py-1.5 text-xs font-medium hover:bg-white/5"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md hover:bg-red-50 text-zinc-500 hover:text-red-600950"
                  >
