...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  SCHEDULED: { label: "Scheduled", color: "text-[#3B82F6]", bg: "bg-blue-500/10" },
  ...
  NSF: { label: "NSF", color: "text-red-400", bg: "bg-red-100950" },
  WAIVED: { label: "Waived", color: "text-zinc-500", bg: "bg-white/10" },
          ...
          <button
            ...
            className={cn(
              ...
              statusFilter === tab.value
                ? "bg-blue-500/10 text-[#162D4A] border-[#C5D9EC] "
                : "text-zinc-500 border-white/[0.08] hover:bg-white/5"
            )}
          >
            {tab.label}
          </button>
              ...
              {payments.map((payment: any) => {
                ...
                return (
                  <tr
                    key={payment.id}
                    className={cn(
                      "border-b last:border-0 hover:bg-white/5",
