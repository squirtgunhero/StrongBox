              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      ...
                      ep.isActive ? "bg-green-500" : "bg-zinc-300"
                    )}
                  />
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {ep.events?.map((ev: string) => (
                        <span
                          key={ev}
                          className="inline-flex items-center rounded-full bg-zinc-100 px-2 py-0.5 text-[10px] text-zinc-600 dark:bg-zinc-800 dark:text-zinc-400"
                        >
                          {ev}
                        </span>
                      ))}
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 rounded-md border px-3 py-1.5 text-xs font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md hover:bg-red-50 text-zinc-400 hover:text-red-600 dark:hover:bg-red-950"
                  >
